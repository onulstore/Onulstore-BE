...
public class QuestionController {
    ...
    // 질문 등록
    @ApiOperation(value = "질문 등록 / 인증 필요")
    @PostMapping("/questions")
    public ResponseEntity<String> insetQuestion(
        @RequestBody QuestionDto.QuestionRequest questionDto) {
        questionService.insertQuestion(questionDto);
        return ResponseEntity.ok("해당 질문이 등록되었습니다.");
    }

    // 질문 수정
    @ApiOperation(value = "질문 수정 / 인증 필요")
    ...
    // 질문 삭제
    @ApiOperation(value = "질문 삭제 / 인증 필요")
    ...
    // 질문 상세 조회
    @ApiOperation(value = "질문 상세 조회 / 인증 필요")
    @GetMapping("/questions/{productId}/{questionId}")
    public ResponseEntity<QuestionDto.QuestionRes> getQuestion(@PathVariable Long productId,
    ...
    public ResponseEntity<List<QuestionDto.QuestionResponse>> getQuestionList(
        @PathVariable Long productId) {
        return ResponseEntity.ok(questionService.getQuestionList(productId));
    }

    // 질문 전체 조회(멤버별)
    @ApiOperation(value = "질문 전체 조회(멤버별) / 인증 필요")
